set top_module fibonacci_calculator
set design_name fib
set rtlPath "../rtl"
...
# read RTL
set rtl_files [glob $rtlPath/*.v] [glob $rtlPath/*.sv]
foreach fi [lsearch -glob -all $rtl_files $rtlPath/*_tb.v] {set rtl_files [lset rtl_files $fi ""]}
...
write -format verilog -hier -output [format "%s%s%s" netlist/ $design_name .vh]
